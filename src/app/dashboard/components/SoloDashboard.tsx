...
export default function SoloDashboard() {
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-orange-600/20 to-gray-800 rounded-lg p-6 border border-orange-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-700 rounded-lg p-4">
            ...
            <p className="text-3xl font-bold text-orange-600">0/500</p>
          </div>
          <div className="bg-gray-700 rounded-lg p-4">
