          ...
          <header className="sticky top-0 z-50 bg-black border-b border-orange-600">
            <nav className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-8">
                <a href="/" className="text-white hover:text-orange-600 transition">Home</a>
                <a href="/#features" className="text-white hover:text-orange-600 transition">Features</a>
                <a href="/#pricing" className="text-white hover:text-orange-600 transition">Pricing</a>
              </div>
