...
import { InboxStats } from '../../../lib/inbox-utils';
...
interface InboxContainerProps {
  ...
  featureLevel: 'basic' | 'limited' | 'full';
  batchId?: string; // Optional: for direct batch links
}
...
export function InboxContainer({ 
  ...
  // Auto-select first batch if none selected and we have batches
  useEffect(() => {
  ...
  const handleDeleteBatch = (batchId: string) => {
    ...
    // For now, we'll just reload the page to refresh data
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-[#2a2a2a] p-4 rounded-lg border border-gray-700">
                <div className="text-2xl font-bold text-white">
                  {featureLevel === 'full' ? 'Pro' : featureLevel === 'limited' ? 'Solo' : 'Lite'}
                </div>
